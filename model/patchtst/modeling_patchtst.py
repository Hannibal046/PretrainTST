...
class PatchTSTForTimeSeriesPrediction(PatchTSTPreTrainedModel):
    ...
    def forward(
        ...
        batch_size,num_channels,num_patch,patch_len = patched_input_values.shape
        hidden_states = self.model(patched_input_values.view(-1,num_patch,patch_len)) # [bs*num_channels,num_patches,patch_len]
